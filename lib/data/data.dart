...
List<Map> mevalar = [
  {
    ...
    "turi": "Meva",
    "ma'lumot": """
Olma (lotincha: Malus) — raʼnodoshlar oilasiga mansub, barg toʻkuvchi daraxtlar yoki butalar turkumi; urugʻli meva daraxti. Shimoliy va janubiy yarim sharning moʻtadil mintaqalarida olmaning 25— 30 turi, jumladan, Sharqiy Osiyo, Oʻrta Osiyo va Kavkazda 10 turi tarqalgan. Ekiladigan mevali daraxtlar orasida maydoni jihatidan birinchi oʻrinda turadi. Yalpi olma hosili boʻyicha AQSH (4,8 mln. t), Xitoy (22,01 mln. t) oldingi oʻrinlarda turadi (1999). Jahon boʻyicha yalpi hosili 60,2 mln. t ni tashkil etadi (1999). Oʻzbekistonda —0,4 mln. t. AQSH, Chili, Xitoy, Rossiya, Eron, Turkiya, Fransiya, Italiya mamlakatlarida olmazorlar katta maydonlarni egallaydi. Shuningdek Oʻzbekistonda 2017—2019-yillarda uzumni keyingi eng koʻp yetishtirilgan meva hisoblanadi.[1] Oʻzbekistonda 8 turi yovvoyi holda uchraydi (qarang yovvoyi olma). Dunyo boʻyicha yetishtiriladigan navlarining asosiy qismi xonaki olma turiga kiradi. Past boʻyli olma turiga kiradigan dusen va paradizkadan mevachilikda payvandtag sifatida foydalaniladi. Olma sovuqqa chidamli, yorugʻsevar va namsevar, tuproq tanlamaydi, lekin unumdor tuproqlarda yuqori hosil beradi. Olma daraxti boʻyi 15 m gacha boradi. Yaponiyada oʻtkazilgan tadqiqotlar shuni koʻrsatadiki, qishda ekilgan „Fuji“ olmalari mart oyining oxirida ildiz oʻsishi kuzatilgan
""",
  },
  {
    "rasm": "asset/anor.png",
...
""",
  },
  {
    ...
    "turi": "Meva",
    "ma'lumot": """
Anjir (Ficus carica L.) — tutdoshlar (anjirgullilar) oilasiga mansub subtropik meva turi. Turkiya, Jazoir, Yevropaning janubida, AQShda katta may-donlarni egallaydi, Kavkaz, Oʻrta Osiyo, Qrimda ham yetishtiriladi. Yovvoyi holda Oʻrta dengiz boʻyi, Kichik Osiyo, Eron, Shimoli-gʻarbiy Hindistonda oʻsadi. A. juda qadimdan madaniylashtirilgan oʻsimlik hisoblanadi (Osiyoda 5 ming yildan, Yevropada kamida 2 ming yildan beri). Botanik tavsifi. A. daraxtining boʻyi 4 — 10 m, shoxlari kalin, yoyilib oʻsadi, novda, barg va mevasida sutsimon shira bor. Bargi yirik, 3 — 7 boʻlmali, baʼzan boʻlmasiz, toʻq yashil, orqasida tu-klari bor. Bir yilda 2 — 3-marta gul-laydi (aprel — may, iyun — iyul, avgust). Mayda bir jinsli gullardan iborat toʻpguli boʻlajak „meva“ ichida boʻlib, mayda blastofaga arilar yordamida chan-glanadi, baʼzilari esa changlanmasdan (partenogenez) va urugʻ tugmasdan meva qiladi. Mevasida 20 — 24% qand, 0,5 — 4,2% pektin moddalari, 3,4 — 7,4% kle-chatka, 0,1% gacha organik kislotalar, ka-rotin, kalsiy, temir, fosfor va boshqa bor. Biologik xususiyatlari. A. asosan bir yillik pishgan novda qalamchalaridan koʻpaytiriladi. 2 — 3 yoshdan meva tugib, 7 — 10 yoshda gʻarq hosilga kiradi, 50 — 80 yil meva beradi, 150 — 200 yilgacha yashaydi. Bir tupi 50 kg gacha meva qiladi.
""",
  },
  {
...
""",
  },
  {
    ...
    "turi": "Meva",
    "ma'lumot": """
Ananas (Ananas) — ananasdoshlar (Bromeliaceae) oilasiga mansub oʻtlar turkumi (urugʻi). 5 — 6 turi maʼlum. Asosan, Amerika qitʼasining tropik hududlarida va Osiyoning Filippin, Tayvan o.larida oʻsadi. Barglari qalin, uzun, xanjarsimon. Ekiladigan A. (A. Sativus) Amerika va Tayvandan boshqa joylarda ham oʻsadi. Bu toʻrning mevasi qubba shaklidagi toʻp me-vadan iborat, ogʻirligi 2 — 5 kg, tusi sargʻish, xushxoʻr. Hoʻl meva yoki konserva holida isteʼmol qilinadi. Baʼzi turlarining barglaridan ipaksimon noziq tolalar ham olinadi.
""",
  },
  {
    "rasm": "asset/kivi.png",
